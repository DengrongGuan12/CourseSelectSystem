...
public class TongshiPanel extends JPanel implements ActionListener{

	JPanel courseInfo;
	JTable jt1;
	JLabel jl1;//放尚未有通识课发布文字
	TableModel tm1;//通识课表
	JScrollPane jsp1;
	JPanel buttonPanel;
	...
	public TongshiPanel(StudentBLService studentBLService,Message message){
		try {
	...
	private void initialPanel(){
		Message message=new Message();
		try {
			message=this.studentBLService.showAllTongshi();
