...
public class GongxuanPanel extends JPanel implements ActionListener{

	private static final long serialVersionUID = 1L;
	JPanel courseInfo;
	JTable jt1;
	JLabel jl1;//放尚未有公选课发布文字
	TableModel tm1;//公选课表
	JScrollPane jsp1;
	JPanel buttonPanel;
	...
	public GongxuanPanel(StudentBLService studentBLService,Message message){
		try {
			UIManager
	...
	private void initialPanel(){
		Message message=new Message();
		try {
			message=this.studentBLService.showAllGongxuan();
